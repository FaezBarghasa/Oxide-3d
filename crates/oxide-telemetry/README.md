...
> Tracing, metrics collection, and crash telemetry diagnostics.

## Overview
`oxide-telemetry` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

OpenTelemetry-compatible tracing, memory usage profiling, performance bottleneck detection, and structured logging.
...
```toml
[dependencies]
oxide-telemetry = { path = "../../crates/oxide-telemetry" }
```

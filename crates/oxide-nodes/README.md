...
> Procedural Geometry Nodes and field-based computational graph engine.

## Overview
`oxide-nodes` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

Blender-style procedural geometry node evaluation, field attributes, domain interpolation, and node group encapsulation.
...
```toml
[dependencies]
oxide-nodes = { path = "../../crates/oxide-nodes" }
```

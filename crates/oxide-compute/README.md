...
> Hardware-abstracted compute task dispatching and kernel execution.

## Overview
`oxide-compute` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

High-level compute graph execution, tensor operations, and memory buffer transfers across backends.

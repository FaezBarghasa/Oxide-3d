...
> Core numerical simulation framework, meshing interfaces, and solver abstractions.

## Overview
`oxide-sim-core` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

Spatial discretization, unstructured mesh generation, boundary condition representation, and linear solver interfaces.
...
```toml
[dependencies]
oxide-sim-core = { path = "../../crates/oxide-sim-core" }
```

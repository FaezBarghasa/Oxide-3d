...
> Precompiled and hand-optimized computational geometry & simulation kernels.

## Overview
`oxide-kernels` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

Micro-benchmarked math routines for ray-triangle intersection, BVH traversal, and numerical quadrature.
...
```toml
[dependencies]
oxide-kernels = { path = "../../crates/oxide-kernels" }
```

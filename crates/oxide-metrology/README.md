...
> Geometric Dimensioning and Tolerancing (GD&T), inspection, and measurement.

## Overview
`oxide-metrology` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

Coordinate Measuring Machine (CMM) inspection paths, nominal vs. actual comparison, and tolerance stack-up analysis.
...
```toml
[dependencies]
oxide-metrology = { path = "../../crates/oxide-metrology" }
```

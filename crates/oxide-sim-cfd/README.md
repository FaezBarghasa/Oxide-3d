...
> Computational Fluid Dynamics (CFD) simulation engine.

## Overview
`oxide-sim-cfd` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

Lattice Boltzmann Method (LBM) flow simulation, aerodynamics pressure maps, and boundary condition modeling.
...
```toml
[dependencies]
oxide-sim-cfd = { path = "../../crates/oxide-sim-cfd" }
```

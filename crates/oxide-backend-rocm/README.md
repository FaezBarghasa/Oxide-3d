...
## Overview
`oxide-backend-rocm` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

GPU compute acceleration on AMD Radeon and Instinct hardware accelerators.
...
```toml
[dependencies]
oxide-backend-rocm = { path = "../../crates/oxide-backend-rocm" }
```

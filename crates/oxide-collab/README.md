...
> Real-time multiplayer collaboration and CRDT document synchronization.

## Overview
`oxide-collab` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

Distributed CRDT sync, peer-to-peer session management, presence tracking, and conflict-free editing.
...
```toml
[dependencies]
oxide-collab = { path = "../../crates/oxide-collab" }
```

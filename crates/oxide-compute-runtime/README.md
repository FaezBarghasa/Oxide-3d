# `oxide-compute-runtime`

> Dynamic runtime compute graph scheduling and resource pool management.

## Overview
`oxide-compute-runtime` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

Asynchronous compute queue management, stream synchronization, and memory caching.
...
```toml
[dependencies]
oxide-compute-runtime = { path = "../../crates/oxide-compute-runtime" }
```

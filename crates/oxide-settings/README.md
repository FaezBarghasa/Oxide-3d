...
> Application preferences, user configuration, keyboard shortcuts, and theme manager.

## Overview
`oxide-settings` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

Persistent TOML/JSON settings schema, workspace presets, mouse gesture configs, and UI themes.
...
```toml
[dependencies]
oxide-settings = { path = "../../crates/oxide-settings" }
```

...
> Embedded Python scripting engine and PyO3 automation bridge.

## Overview
`oxide-script-python` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

Interactive Python REPL console, macro recording, and CAD/CAE automation bindings via Python.
...
```toml
[dependencies]
oxide-script-python = { path = "../../crates/oxide-script-python" }
```

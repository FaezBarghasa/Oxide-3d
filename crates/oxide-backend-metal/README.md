...
## Overview
`oxide-backend-metal` is an integral crate in the **Oxide-3D** industrial CAD/CAE/CAM/DCC ecosystem. 

Metal compute pipeline integration for Apple Silicon unified memory architectures.
...
```toml
[dependencies]
oxide-backend-metal = { path = "../../crates/oxide-backend-metal" }
```
